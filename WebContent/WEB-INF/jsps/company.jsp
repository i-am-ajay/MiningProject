...
<body class=mt-1>
	...
	<div class="container p-2 m-auto">
		<h4 class="border-bottom m-3 text-muted pb-2" id="form_title">Client Creation</h4>
		<f:form method="POST" modelAttribute="client" action="save_client">
		   ...
		   <div class="card text-dark bg-light px-3 mb-3" >
				<div class="card-header mt-1">Client Creation</div>
  				<div class="card-body">
  					<div class="row">
  						<div class="col-md-6">
					    	...
					    	<div class="form-group">
					      		<label for="testDate" class="font-weight-bold">Phone No</label>
	...
	<input type="submit" class="btn btn-small btn-secondary btn-block w-75 mx-auto" value="Save Client"/>
